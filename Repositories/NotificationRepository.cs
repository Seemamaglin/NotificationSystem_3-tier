...
namespace Notification_System_CRUD.Repositories
{
    public class NotificationRepository
    {
        ...
        {
            string sql=@"INSERT INTO notifications(message,notification_type,sent_date,status,recipient_name,recipient_contact,user_id)
                VALUES(@message,@type,@sentdate,@status,@recipientName,@recipientContact,@userId)
                RETURNING id";
